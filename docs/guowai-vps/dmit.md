...
| ----- | ---- | ---- | ------ | -------- | --------------------------------------------------------- |
| 1核心 | 1G   | 20G  | 1TB    | $49.9/年 | [点击购买](https://www.dmit.io/aff.php?aff=7952&pid=186 ) |

对于IP完全被墙的情况，距离开机7天，距上一次更换IP满15天可要求更换1次IP。ICMP 和 TCP 所有端口都已被封禁算完全被墙。

### PVM.LAX.EB.WEE

该系列移动通过CMIN2 、电信联通通过AS9929回程（EB系列不保证线路）。CMIN2是移动推出的精品优化网，对标电信的CN2。
...
| CPU   | 内存 | SSD  | 月流量 | 价格     | 购买链接                                                     |
| ----- | ---- | ---- | ------ | -------- | ------------------------------------------------------------ |
| 1核心 | 1G   | 10G  | 1TB    | $49.9/年 | [点击购买](https://www.dmit.io/aff.php?aff=7952&pid=188)（已缺货） |
