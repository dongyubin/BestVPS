...
其中官网和部分镜像站在国内是无法直接访问的，**6个网站的数据全部互通**，所以我们只需要直接访问镜像站5就行了，以后本站的所有搬瓦工机场官网都以镜像站5表示（最稳定），方便大家在国内直接访问。
...
| 名称                 | 说明                                           |
| -------------------- | ---------------------------------------------- |
| Upgrade Plan         | 升级该节点为更高级的套餐或降级套餐             |
